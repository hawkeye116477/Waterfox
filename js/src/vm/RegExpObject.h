...
class RegExpObject : public NativeObject
{
  ...
  public:
    ...
    static RegExpObject* create(JSContext* cx, const CharT* chars,
    ...
    static RegExpObject* create(JSContext* cx, const CharT* chars,
                                ...
                                LifoAlloc& alloc, NewObjectKind kind);

    static RegExpObject* create(JSContext* cx, HandleAtom atom,
                                JS::RegExpFlags flags, LifoAlloc& alloc,
