...
class RegExpStatics
{
  ...
  public:
    ...
    inline bool updateFromMatchPairs(JSContext* cx, JSLinearString* input, VectorMatchPairs& newPairs);
...
inline bool
RegExpStatics::updateFromMatchPairs(JSContext* cx, JSLinearString* input, VectorMatchPairs& newPairs)
{
    MOZ_ASSERT(input);
